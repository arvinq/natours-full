...
console.log('Hello from the client side - Login'); //since we implemented parcel which is a js bundler, we need to export this login
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              e.target.textContent = 'Processing...'; // in JS, anything in data attribute that has a dash ( - ) will be converted to camel case when accessed here in JS
