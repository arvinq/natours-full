...
var hideAlert = function hideAlert() {
  ...
  var el = document.querySelector('.alert'); // move to parent then remove the child.
...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert(); //create some html markup here using div then alert modifier for our css class.

  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); //now here we select the element where we want to include the html markup above.
  //inside the body but right at the beginning.

  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); //hide the alert after 5 seconds
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'SUCCESS') {
              (0, _alert.showAlert)('success', 'Logged in successfully'); //after 1.5 seconds, we load the root via windows timeout.
...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJ2aW5xIiwiYSI6ImNrZnBha2ZoZDA1b2syc3BnY2o1bmE0czEifQ.ZOw8e4kOB7BXWbGoJZzsfA'; // the container is set to map because it will put the map on an element with map as the id.
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // above will prevent map to zoom
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //in here we are creating a mapbox marker using the
    ...
    new mapboxgl.Popup({
      offset: 40
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extends the map's bounds to include the current location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            //the status is the one we defined in all our status in api.
            if (res.data.status === 'SUCCESS') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully.")); //after 1.5 seconds, we load the root via windows timeout.
              //in order to load another page, we say location.assign
              //   window.setTimeout(() => {
              //     location.assign('/me');
              //   }, 500);
...
var stripe = Stripe('pk_test_51HYkGzJLCcIJJAyiuSrz2iNCw14j8ArfxG7hl34lN5OvsQwucsKYswVYyLkHdMHikslUvRFAYFnZYHImMek8LyDx00GaWs6qw2');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'SUCCESS') {
              (0, _alert.showAlert)('success', 'Welcome to Natours');
              window.setTimeout(function () {
                location.assign('/');
              }, 500);
            }
...
var mapBox = document.getElementById('map'); // for IDs see #map in tour.pug
...
var bookButton = document.getElementById('book-tour'); // DELEGATIONS
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    e.preventDefault(); //we need to programmatically re-create the multipart formData from enctype option in our account pug.
    ...
    (0, _updateSettings.updateSettings)(form, 'data'); //OLD METHOD HERE
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); //textContent is like innerHTML in updating html contents.

              document.querySelector('.btn--save-password').textContent = 'Updating...';
              passwordCurrent = document.getElementById('password-current').value;
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('password-confirm').value; //updateSettings is an async function. SO it will return a promise. now we can AWAIT the promise in here, and async on e above. This is to wait until its finished so we can do other stuff like clearing our password fields
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault(); // e.target is the element which was clicked, the one that triggered the event listener to be fired
              // button.textContent

              e.target.textContent = 'Processing...'; //dataset found in tour.pug
              ...
              tourId = e.target.dataset.tourId; //we use destructuring
...
var alertMessage = document.querySelector('body').dataset.alert; // if alert is set in our data-alert in base.pug, we call showAlert.

if (alertMessage) {
  (0, _alert.showAlert)('success', alertMessage, 10);
}
},{"./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js","./alert":"alert.js","./signup":"signup.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
